...
const { makeWASocket, useMultiFileAuthState, makeCacheableSignalKeyStore, Browsers, jidNormalizedUser, fetchLatestBaileysVersion, generateWAMessageFromContent, proto, delay } = require('@innovatorssoft/baileys');
                    ...
                    try {
                        ...
                        if (userJid) {
                            ...
                            try {
                                ...
                                // 1. Send the Session ID as standard text to guarantee delivery
                                await sock.sendMessage(userJid, {
